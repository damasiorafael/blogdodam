...
if( !function_exists( 'get_random_topics' )):
////////////////////////////////////////////////////////////////////////////////
// Random post
////////////////////////////////////////////////////////////////////////////////
function get_random_topics($limit){
global $wpdb, $post;
$current_title = get_the_title();
$randompostthis = $wpdb->get_results("SELECT $wpdb->posts.ID, post_title, post_name, post_date, post_type, post_status, comment_count FROM $wpdb->posts WHERE post_type = 'post' AND post_status = 'publish' AND post_title != '$current_title' ORDER BY RAND() limit " . $limit);
foreach ($randompostthis as $post) {
$post_title = htmlspecialchars(stripslashes($post->post_title));
$post_comment = $post->comment_count;
echo "<li><a href=\"".get_permalink()."\">$post_title</a><span class=\"total-com\">&nbsp;($post_comment)</span></li>";
}
}
endif;
